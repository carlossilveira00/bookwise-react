...
const BookModal = ({open, handleClose,title, author, description, category, thumbnail_url, ISBN, bookId}) => {
  ...
  const handleAddBook = () => {
    ...
    const userBook = { book_association: {book_id: bookId, user_id: auth.user.user.id}}
